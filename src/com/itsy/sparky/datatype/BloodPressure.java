...
public class BloodPressure extends DataType {
    ...
    // TechID first readings == logged in person, second readings can be new technician

    // tab order

    // ajax-centric

    // thresholdable value, pass in procedure types, donation types, threshold notification type
