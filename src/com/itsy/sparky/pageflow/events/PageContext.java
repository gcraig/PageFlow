...
public final class PageContext {
	...
	/**
	 * Adds the HttpSession to the current context, but dynamically to 
	 * decouple the web and service tiers.
	 * @param httpSession
	 */
	...
	/**
	 * Adds the HttpRequest to the current context, but dynamically to 
	 * decouple the web and service tiers.
	 * @param httpSession
	 */
